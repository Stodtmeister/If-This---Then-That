...
export default function AddToBoard({ bookId, setClickedBookId, mainBook, top3 }) {
  ...
  return (
    <div className={`board-choices ${mainBook ? 'main-book': '', top3 ? 'top-3': ''}`}>
      <select className={`the-select ${mainBook ? 'main-book' : '', top3 ? 'top-3': ''}`} onChange={(e) => {
